<div id="addAdminMenu">
    ...
    <form enctype="multipart/form-data" action="" method="post">
        <table class="login">
            <tr>
                <th colspan="2">Изменить портфолио</th>
            </tr>
            <tr>
                <td style="text-align: right">Название:</td>
                <td><input type="text" name="name" value="<?php echo $data['edit']['name']?>"/></td>
            </tr>
            <tr>
                <td style="text-align: right">Тип:</td>
                <td><input type="text" name="type" value="<?php echo $data['edit']['type']?>"/></td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="text-align: right" colspan="2"><input type="submit" value="Изменить"
